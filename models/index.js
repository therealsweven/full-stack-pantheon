...
//Ticket items
Menu_items.belongsToMany(Ticket, {through: Ticket_items, foreignKey: 'menu_item_id'});
Ticket.belongsToMany(Menu_items, {through: Ticket_items, foreignKey: 'ticket_id'});
...
//Allergens
Menu_items.belongsToMany(Allergens, {through: Menu_item_allergens, foreignKey: 'menu_item_id'});
Allergens.belongsToMany(Menu_items, {through: Menu_item_allergens, foreignKey: 'allergen_id'});
